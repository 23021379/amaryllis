...
def main():
    """
    Orchestrates the creation of the SPA L1 artifact per Directive 037.
    This script ingests the raw SPA data, performs critical sanitization,
    ...
    # MANDATE 3: Geometric Validation & Repair. Mitigate risk from complex coastal/estuarine polygons.
    ...
    # --- Persistence ---
    logging.info(f"[REDACTED_BY_SCRIPT]")
    gdf.to_file(output_path, driver='GPKG', layer='spa_england')
