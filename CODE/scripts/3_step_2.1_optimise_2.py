...
OPTUNA_TRIALS_HEAD = 20 # Mandate Increased: Deeper search for head model tuning.
OPTUNA_TRIALS_ARBITER = 10 # Mandate Increased: Deeper search for arbiter tuning.
...
COHORT_SOCIO_ECONOMIC_ALL = [
    ...
    "[REDACTED_BY_SCRIPT]",
    "[REDACTED_BY_SCRIPT]",
    "site_lsoa_ruc_rural_score",
    "[REDACTED_BY_SCRIPT]",
    "delta_property_value",
    "delta_env_health_disadvantage",
    "[REDACTED_BY_SCRIPT]"
]
...
def phase_0_get_gcv(X, y, n_features=20, head_params=None):
    ...
    if head_params is None:
        ...
        head_params = {'objective': 'regression_l1', 'metric': 'mae', 'random_state': RANDOM_STATE, 'n_estimators': 500}
...
def engineer_strategic_interaction_features(df: pd.DataFrame) -> pd.DataFrame:
    """
    Architectural Mandate AD-AMARYLLIS-MOD-07 & v4.0 Synthesis Mandate:
...
def define_all_cohorts(gcv: list):
    """
    Defines, sanitizes, and fortifies the v4.0 Expert Head ensemble structure
    ...
    # --- v4.0 EXPERT HEAD DEFINITIONS (Deconstructed from Monoliths) ---

    # LPA EXPERTS
    LPA_EFFICIENCY = ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lpa_total_experience', 'lpa_workload_trend', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']
    LPA_DISPOSITION = ['lpa_withdrawal_rate', 'lpa_major_commercial_approval_rate', 'lpa_approval_rate_cps2', '[REDACTED_BY_SCRIPT]']
    LPA_PRECEDENT = ['nearby_legacy_count', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']

    # GRID EXPERTS
    GRID_CONNECTION_POINT = ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'avg_max_ef_fault_5nn_ka', '[REDACTED_BY_SCRIPT]', 'avg_total_kva_5nn', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'sitevoltage', 'powertransformercount', 'transratingwinter', 'transratingsummer', 'resistance_ohm', 'reversepower_encoded', 'substation_age_at_submission', 'kva_per_transformer', '[REDACTED_BY_SCRIPT]']
    GRID_OPERATIONAL_REALITY = ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lct_total_connections_in_5km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lct_ev_connections_in_5km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lct_reconciliation_delta_connections', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'pq_idw_thd_knn5', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'pq_max_thd_in_knn5', 'pq_std_thd_in_knn5', 'maxdemandsummer', 'maxdemandwinter', 'is_hot_site', '[REDACTED_BY_SCRIPT]', 'has_demand_data', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'sec_sub_gov_area_sqm', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']
    GRID_TOPOLOGY_FRICTION = ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'ohl_local_structure_count', 'ohl_local_tower_count', 'ohl_local_tower_ratio', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'ohl_nearest_voltage', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']
    GRID_STRATEGIC_CONTEXT = ['idno_is_within', '[REDACTED_BY_SCRIPT]', 'idno_count_in_5km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lpa_idno_area_as_percent_of_total_area', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'ltds_count_in_10km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'dnoa_avg_dist_knn_m', 'dnoa_avg_deferred_kva_knn', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']

    # ENV EXPERTS
    ENV_STATUTORY_VETOES = ['sssi_dist_to_nearest_m', 'sssi_is_within', 'sssi_count_in_2km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'sssi_unit_dist_to_nearest_m', 'sssi_unit_worst_condition_in_2km', 'np_dist_to_nearest_m', 'np_is_within', 'np_count_in_2km', '[REDACTED_BY_SCRIPT]', 'lpa_np_coverage_pct', 'aonb_dist_to_nearest_m', 'aonb_is_within', 'aonb_count_in_2km', 'aonb_total_area_in_5km', '[REDACTED_BY_SCRIPT]', 'sac_dist_to_nearest_m', 'sac_is_within', 'sac_count_in_2km', '[REDACTED_BY_SCRIPT]', 'lpa_sac_coverage_pct', 'spa_dist_to_nearest_m', 'spa_is_within', 'spa_count_in_2km', '[REDACTED_BY_SCRIPT]', 'lpa_spa_coverage_pct', 'aw_dist_to_nearest_m', 'aw_is_within', 'aw_count_in_2km', 'aw_total_area_in_5km', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]']
    ENV_POLICY_FRICTION = ['alc_grade_at_site', 'alc_is_bmv_at_site', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'cs_on_site_bool', 'cs_on_site_pct_area', 'cs_on_site_total_value', 'cs_count_2km', 'cs_density_2km', 'cs_density_5km', 'cs_density_10km', 'cs_density_20km', '[REDACTED_BY_SCRIPT]', 'cs_avg_value_20km', 'es_on_site_bool', 'es_count_2km', 'es_total_area_ha_2km', 'es_hls_on_site_bool', 'es_hls_on_site_pct_area', 'es_hls_density_2km', 'es_hls_density_5km', 'es_hls_density_10km', 'es_hls_density_20km', 'nt_dist_to_nearest_m', 'nt_intersection_count_in_2km', 'nt_length_in_2km', '[REDACTED_BY_SCRIPT]', 'crow_is_within', '[REDACTED_BY_SCRIPT]', 'crow_nearest_is_rcl', 'crow_nearest_is_s15', 'hp_dist_to_nearest_m', 'hp_is_within', 'hp_count_in_2km', 'hp_total_area_in_5km_ha', '[REDACTED_BY_SCRIPT]']
    ENV_ECOLOGICAL_FABRIC = ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'aw_AWP_count_in_2km', 'ph_dist_to_nearest_m', 'ph_is_within', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'ph_nearest_is_priority']

    # --- ENSEMBLE CONSTRUCTION ---
    all_cohorts = {
        # Foundational Cohorts (Preserved)
        "CORE_ATTRIBUTES": _sanitize(COHORT_CORE_ATTRIBUTES),
        "SOCIO_ECONOMIC_ALL": _sanitize(COHORT_SOCIO_ECONOMIC_ALL),
        "NATIONAL_PROXY_ALL": _sanitize(COHORT_NATIONAL_PROXY_ALL),
        "METADATA_AND_FLAGS": _sanitize(COHORT_METADATA_AND_FLAGS),

        # v4.0 Expert Heads
        "LPA_EFFICIENCY": _sanitize(LPA_EFFICIENCY),
        "LPA_DISPOSITION": _sanitize(LPA_DISPOSITION),
        "LPA_PRECEDENT": _sanitize(LPA_PRECEDENT),
        "GRID_CONNECTION_POINT": _sanitize(GRID_CONNECTION_POINT),
        "[REDACTED_BY_SCRIPT]": _sanitize([REDACTED_BY_SCRIPT]),
        "[REDACTED_BY_SCRIPT]": _sanitize([REDACTED_BY_SCRIPT]),
        "[REDACTED_BY_SCRIPT]": _sanitize([REDACTED_BY_SCRIPT]),
        "ENV_STATUTORY_VETOES": _sanitize(ENV_STATUTORY_VETOES),
        "ENV_POLICY_FRICTION": _sanitize(ENV_POLICY_FRICTION),
        "[REDACTED_BY_SCRIPT]": _sanitize([REDACTED_BY_SCRIPT]),

        # v4.0 Surgical Interaction Cohorts (New and Existing)
        "SIC_CUMULATIVE_IMPACT": ['[REDACTED_BY_SCRIPT]', #'solar_site_area_sqm', 
                                  'cs_density_5km', '[REDACTED_BY_SCRIPT]'],
        "[REDACTED_BY_SCRIPT]": ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', _sanitize(['[REDACTED_BY_SCRIPT]'])[0], '[REDACTED_BY_SCRIPT]'],
        "[REDACTED_BY_SCRIPT]": ['[REDACTED_BY_SCRIPT]', '[REDACTED_BY_SCRIPT]', 'lpa_major_commercial_approval_rate', 'lpa_workload_trend'],
    }

    # Fortify the Ensemble Heads with the GCV
    fortified_cohorts = {}
    print("[REDACTED_BY_SCRIPT]")
...
def phase_1_load_and_prepare_data():
    ...
    # This prevents data poisoning from failed (0, -1) or invalid (NaN) cases.
    valid_indices = y_reg[y_reg > 0].index
...
def phase_A_tune_head_models(X, y, grid_cohort_features):
    ...
    def objective(trial):
        ...
        # ARCHITECTURAL MANDATE: All CV and training must use a leak-proof pipeline.
        pipeline = Pipeline([
        ...
        score = cross_val_score(pipeline, X_grid, y, cv=KFold(n_splits=5, shuffle=True, random_state=RANDOM_STATE), scoring='neg_root_mean_squared_error').mean()
        return -score
...
def phase_B_tune_arbiter_model(X, y, cohorts, global_features, unified_head_params):
    ...
    def objective(trial):
        ...
        for train_idx, val_idx in cv_inner.split(X, y):
            ...
            for cohort_name, features in cohorts.items():
                ...
                head_pipeline = Pipeline([
                    ('imputer', SimpleImputer(strategy='median')),
                    ('scaler', StandardScaler()),
                    ('regressor', lgb.LGBMRegressor(**unified_head_params, random_state=RANDOM_STATE, verbosity=-1))
                ])
                head_pipeline.fit(X_train[model_features], y_train)
                preds = head_pipeline.predict(X_val[model_features])
        ...
        arbiter_pipeline = Pipeline([
            ('imputer', SimpleImputer(strategy='median')),
            ('scaler', StandardScaler()),
            ('regressor', lgb.LGBMRegressor(**arbiter_params))
        ])
        
        score = cross_val_score(arbiter_pipeline, final_training_matrix, y, cv=cv_inner, scoring='neg_root_mean_squared_error').mean()
        return -score
...
def phase_C_train_final_production_model(X, y, cohorts, global_features, head_params, arbiter_params):
    ...
    final_arbiter_pipeline = Pipeline([
        ('imputer', SimpleImputer(strategy='median')),
        ('scaler', StandardScaler()),
        ('regressor', lgb.LGBMRegressor(**arbiter_params, random_state=RANDOM_STATE, verbosity=-1))
    ])
    final_arbiter_pipeline.fit(final_training_matrix, y)
    
    joblib.dump(final_arbiter_pipeline, MODEL_ARBITER_PATH)
    print(f"[REDACTED_BY_SCRIPT]")

    print("Phase C Complete.")
    return final_arbiter_pipeline, final_training_matrix
...
def phase_E_generate_final_audit_report(model, X_meta, baseline_rmse, final_rmse, num_heads):
    ...
    print("[REDACTED_BY_SCRIPT]")
    # ARCHITECTURAL MANDATE: SHAP must explain the final model step using data processed by the pipeline.
    # Passing the pipeline directly to the explainer handles this correctly.
    explainer = shap.Explainer(model.named_steps['regressor'], model.named_steps['scaler'].transform(model.named_steps['imputer'].transform(X_meta)))
    shap_values = explainer(model.named_steps['scaler'].transform(model.named_steps['imputer'].transform(X_meta)))
...
if __name__ == '__main__':
    ...
    all_cohorts = define_all_cohorts(gcv=GLOBAL_CONTEXT_VECTOR)
    print("-"*80)
    ...
    # Mandate Correction: COHORT_GRID_ALL is defunct. Using GRID_OPERATIONAL_REALITY as the new complex proxy.
    print("[REDACTED_BY_SCRIPT]")
    unified_head_params = phase_A_tune_head_models(X_final, y_final, all_cohorts['[REDACTED_BY_SCRIPT]'])
